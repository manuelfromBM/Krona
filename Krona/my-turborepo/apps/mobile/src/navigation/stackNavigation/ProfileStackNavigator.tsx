...
import DashboardSelectorScreen from "src/screens/dashboard/DashboardSelectorScreen";  // importamos dashboard
...
export default function ProfileStackNavigator() {
  return (
    <Stack.Navigator>
      ...
      <Stack.Screen name="Dashboard" component={DashboardSelectorScreen} options={{title: "Dashboard"}} /> 
