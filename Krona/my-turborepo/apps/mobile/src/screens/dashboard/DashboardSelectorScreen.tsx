// CODIGO NUEVO Y MEJORADO DE LA SELECCION DE DASHBOARD FREE Y PREMIUM
//********************************************************************** */
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <View style={[styles.card, styles.cardFree]}>
          <Icon name="leaf-outline" size={40} color="#2ecc71" /> {/* ICONO DE HOJA VERDE */}
        ...
        <View style={[styles.card, styles.cardPremium]}>
          ...
          <Icon name="diamond-outline" size={40} color="#fff" /> {/* ICONO DE DIAMANTE BLANCO */}
